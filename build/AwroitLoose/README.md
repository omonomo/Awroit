## 全角英数や半角カナが判別しやすいプロポーショナルフォント「Awroit」(Loose 版)

Copyright (c) 2025 omonomo ([https://omonomo.github.io/Awroit/](https://omonomo.github.io/Awroit/))

## 簡単な説明

自作合成フォント [Cyroit](https://omonomo.github.io/Cyroit/) に [iA Writer Quattro](https://github.com/iaolo/iA-Fonts) と [IBM Plex Mono](https://github.com/IBM/plex) を合成しました。
...
[iA Writer Quattro (Version 2.000)]  
Copyright 2017 IBM Corp. and iA Inc. All rights reserved.  
([https://github.com/iaolo/iA-Fonts](https://github.com/iaolo/iA-Fonts))  
主にラテン文字、ギリシア文字、キリル文字で使用しています。iA Writer Quattro のライセンスは [SIL Open Font License v1.1](https://github.com/iaolo/iA-Fonts/blob/master/iA%20Writer%20Quattro/LICENSE.md) です。

[IBM Plex Mono (Version 2.004)]  
Copyright 2017 IBM Corp. All rights reserved.  
([https://github.com/IBM/plex](https://github.com/IBM/plex))  
iA Writer Quattro のグリフ補完で使用しています。IBM Plex Mono のライセンスは [SIL Open Font License v1.1](https://github.com/IBM/plex/blob/master/LICENSE.txt) です。
...
主に iA Writer Quattro に含まれない文字の補完で使用しています。Inconsolata のライセンスは [SIL Open Font License v1.1](https://github.com/google/fonts/blob/main/ofl/inconsolata/OFL.txt) です。
...
[SIL Open Font License Version 1.1](https://github.com/omonomo/Awroit/blob/main/build/AwroitLoose/OFL.txt)

## 謝辞

Awroit の合成、製作にあたり、素晴らしいフォントやツール類を提供してくださっております製作者の方々に感謝いたします。

...
最新版 v1.4.0 (2026-07-19)

| リンク                                                                                                      | 説明                                            |
| ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| [フォント (Awroit)](https://github.com/omonomo/Awroit/releases/download/v1.4.0/Awroit_v1.4.0.zip)           | 通常版。半角幅が全角の1/2。                     |
| [フォント (AwroitLoose)](https://github.com/omonomo/Awroit/releases/download/v1.4.0/AwroitLoose_v1.4.0.zip) | 文字間隔ゆるい版。半角幅が全角の9/16。          |
| [ソースコード](https://github.com/omonomo/Awroit/archive/refs/tags/v1.4.0.zip)                              | 使用方法は[下の方](#基本的な使い方)にあります。 |
...
| 名称      | サンプル                                                 | 説明                                                                                                                    |
| --------- | -------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| Awroit    | <img alt="Normal" src="./images/Normal.png" width="250"> | 通常版。スタイルセット対応。<br> 内容については後述。                                                                   |
| Awroit EH | <img alt="EH" src="./images/EH.png" width="250">         | 絵文字減らした版。スタイルセット対応。別の絵文字フォントとの併用推奨。<br>(サンプルの㊙は Apple Color Emoji のものです) |
| Awroit BS | <img alt="BS" src="./images/BS.png" width="250">         | 基本版。<br> 全角スペースを可視化しています。                                                                           |
| Awroit SP | <img alt="SP" src="./images/SP.png" width="250">         | スペシャルスペース版。<br> 半角スペース、ノーブレークスペースや em スペース等も可視化したバージョン。                   |
| Awroit DG | <img alt="DG" src="./images/DG.png" width="250">         | 桁区切り表示版。<br> たくさん並んだ数字とにらめっこする時間を短縮できます。                                             |
| Awroit FX | <img alt="TS" src="./images/FX.png" width="250">         | 記号位置固定版。<br> calt と相性が悪いソフト用。                                                                        |
| Awroit HB | <img alt="HB" src="./images/HB.png" width="250">         | 平凡版。全てのスペースが不可視でグリフ改変も抑えたバージョン。<br> プリントアウト用にどうぞ。                           |

...
# Custom font generator for Awroit
#
...
address_vert_start_liga="1114181" # 合成後のvert置換の先頭アドレス (リガチャあり)
lookupIndex_liga_end_liga="0" # リガチャ用caltの最終lookupナンバー (リガチャあり)
...
copyright="${copyright}\" + \"[iA Writer Quattro]\nCopyright 2017 IBM Corp. and iA Inc. All rights reserved.\n\n"
copyright="${copyright}\" + \"[IBM Plex Mono]\nCopyright 2017 IBM Corp. All rights reserved.\n\n"
...
move_y_super="340" # 基本から作成した上付き文字のY座標移動量 (すでにある上付き文字のベースラインのY座標)
...
move_y_super_base="31" # ベースフォントの上付き文字Y座標移動量 (Latin フォントとベースラインを合わせる)
move_y_sub_base="0" # ベースフォントの下付き文字Y座標移動量 (Latin フォントとベースラインを合わせる)

# latin 括弧移動量 (ベースフォントと中心を合わせる)
move_y_latin_bracket="35"

# latin アンダーバー移動量
move_y_latin_underbar="66"

# 全角アンダーバー移動量 (Latin フォントと高さを合わせる)
move_y_zenkaku_underbar="-12"
...
# 演算子移動量
move_y_math="6" # 通常
move_y_s_math="3" # 上付き、下付き
move_y_zenkaku_math="-10" # ベースフォントの演算子上下移動量 (Latin フォントと高さを合わせる)
...
calt_init() {
    ...
    move_y_calt_colon=$((move_y_math + 46)) # : のY座標移動量 (= 基準)
    ...
    move_y_calt_math=$((- move_y_math + 44)) # +-= のY座標移動量 (括弧基準)
    ...
    move_y_calt_colon2="84" # : のY座標移動量 (括弧基準)
    ...
    move_y_calt_bar2="34" # | のY座標移動量 (括弧基準)
...
width_latin_thin="307" # Latin フォントの em 値を1024に変換したときの文字幅の1/2
width_latin_narrow="460" # Latin フォントの em 値を1024に変換したときの文字幅の3/4
width_latin_wide="921" # Latin フォントの em 値を1024に変換したときの文字幅の3/2
move_x_calt_quote="8" # クォートのX座標戻り量 (move_x_calt_symbol から引く)

# 通常版用
scale_width_latin="84" # Latin フォントの半角英数文字の横拡大率
scale_height_latin="91.5" # Latin フォントの半角英数文字の縦拡大率
...
width_hankaku_hair="128" # 半角文字幅の1/4
width_hankaku_thin="256" # 半角文字幅の1/2
width_hankaku_narrow="384" # 半角文字幅の3/4
width_hankaku_wide="768" # 半角文字幅の3/2
move_x_calt_latin="16" # ラテン文字のカーニングX座標移動量
move_x_calt_symbol="32" # 記号のカーニングX座標移動量
move_x_hankaku="0" # 半角文字移動量
move_x_hankaku_narrow="0" # 半角文字移動量(3/4)
move_x_hankaku_wide="0" # 半角文字移動量(3/2)

# Loose 版用
scale_width_latin_loose="93.9" # Latin フォントの半角英数文字の横拡大率 (Loose 版)
scale_height_latin_loose="93.9" # Latin フォントの半角英数文字の縦拡大率 (Loose 版)
...
width_hankaku_hair_loose="144" # 半角文字幅の1/4 (Loose 版)
width_hankaku_thin_loose="288" # 半角文字幅の1/2 (Loose 版)
width_hankaku_narrow_loose="432" # 半角文字幅の3/4 (Loose 版)
width_hankaku_wide_loose="864" # 半角文字幅の3/2 (Loose 版)
...
move_x_hankaku_narrow_loose=$(((width_hankaku_narrow_loose - ${width_hankaku_narrow}) / 2)) # 半角文字移動量 (Loose 版 3/4)
move_x_hankaku_wide_loose=$(((width_hankaku_wide_loose - ${width_hankaku_wide}) / 2)) # 半角文字移動量 (Loose 版 3/2)
...
# Set filenames
origin_latin_regular="iAWriterQuattroS-Regular.ttf"
origin_latin_bold="iAWriterQuattroS-Bold.ttf"
origin_latin_regular2="IBMPlexMono-Regular.ttf"
origin_latin_bold2="IBMPlexMono-Bold.ttf"
...
# Get options
 # while getopts hVxXf:vlN:n:waLZzyubtOQsceojSdPp OPT
...
do
    case "${OPT}" in
        ...
        "w" )
            ...
            width_hankaku_hair=${width_hankaku_hair_loose} # 半角文字幅の1/4
            width_hankaku_thin=${width_hankaku_thin_loose} # 半角文字幅の1/2
            width_hankaku_narrow=${width_hankaku_narrow_loose} # 半角文字幅の3/4
            width_hankaku_wide=${width_hankaku_wide_loose} # 半角文字幅の3/2
            move_x_hankaku=${move_x_hankaku_loose} # 半角文字移動量
            move_x_hankaku_narrow=${move_x_hankaku_narrow_loose} # 半角文字移動量(3/4)
            move_x_hankaku_wide=${move_x_hankaku_wide_loose} # 半角文字移動量(3/2)
...
# Edit latin font2
    ...
    Select(65536, 65677); Clear(); DetachAndRemoveGlyphs()
...
# 使用しないグリフクリア
    Print("Remove not used glyphs")
    Select(0, 31); Clear(); DetachAndRemoveGlyphs()
    Select(65536, 65580); Clear(); DetachAndRemoveGlyphs()
 #    Select(65581); Clear(); DetachAndRemoveGlyphs() # スラッシュ0
 #    Select(65582); Clear(); DetachAndRemoveGlyphs() # ドット無し0
    Select(65583, 65664); Clear(); DetachAndRemoveGlyphs()
...
# 0 (ドットを小さくする)
    ...
    ChangeWeight(30)
    Copy()
    Select(0u0030); PasteInto() # 0
    OverlapIntersect()

    Select(65552);  Copy() # Temporary glyph
    Select(0u0030); PasteInto() # 0
    SetWidth(${width_latin})
    Select(65552, 65553);  Clear() # Temporary glyph
...
# 1 (鼻先を少しカット)
    ...
    if (input_list[i] == "${input_latin_regular}")
        ...
        Rotate(52)
        Move(0, 370 + 90)
        PasteWithOffset(250, -550)
    endif
    PasteWithOffset(0, -600)
    RemoveOverlap()
    Copy()
    Select(0u0031); PasteInto() # 1
    OverlapIntersect()
    SetWidth(${width_latin})
...
# D (ss 用、クロスバーを付加することで少しくどい感じに)
    ...
    if (input_list[i] == "${input_latin_regular}")
        Scale(80, 109); Copy()
        Select(0u0044) # D
        PasteWithOffset(-162, -326)
    else
        Scale(95, 110); Copy()
        Select(0u0044) # D
        PasteWithOffset(-160, -322)
    endif
    SetWidth(${width_latin})
    RemoveOverlap()
    Select(65552);  Clear() # Temporary glyph

# I (セリフを付けて narrow にする)
    Select(0u00af); Copy() # macron
    Select(65552);  Paste() # Temporary glyph
    if (input_list[i] == "${input_latin_regular}")
        Scale(90, 107)
    ...
    Move(-(${width_latin} - ${width_latin_narrow}), 0)
    Copy()
 ...
 #    SelectMore(0u1e2e) # Ḯ
    ...
    SelectMore(0u0399) # Ι
    SelectMore(0u03aa) # Ϊ
    SelectMore(0u1f38, 0u1f3f) # ἸἹἺἻἼἼἽἾἿ
    SelectMore(0u1fd8, 0u1fdb) # ῘῙῚΊ
    # キリル文字
    SelectMore(0u0406) # І
    SelectMore(0u0407) # Ї
    if (input_list[i] == "${input_latin_regular}")
...
# V (ss用、左上にセリフを追加してYやレと区別しやすく)
    ...
    if (input_list[i] == "${input_latin_regular}")
        Scale(85, 109); Copy()
        Select(0u0056); # V
        PasteWithOffset(-205, -10) # V
    else
        Scale(90, 110); Copy()
        Select(0u0056); # V
        PasteWithOffset(-195, -25) # V
    endif
...
# Z (ss用、クロスバーを付加してゼェーットな感じに)
    ...
    Select(65552);  Paste() # Temporary glyph
    if (input_list[i] == "${input_latin_regular}")
        Scale(105, 109); Rotate(-2)
        Copy()
        Select(0u005a) # Z
        PasteWithOffset(-9, -330)
    else
        Scale(110, 110); Rotate(-2)
        Copy()
        Select(0u005a) # Z
        PasteWithOffset(-6, -325)
    endif
    SetWidth(${width_latin})
    RemoveOverlap()
    Select(65552);  Clear() # Temporary glyph
...
# i (セリフを付けて右に移動、narrow にする)
 ...
 #    SelectMore(0u1e2f) # ḯ
    ...
    SelectMore(0u0457) # ї
    if (input_list[i] == "${input_latin_regular}")
        PasteWithOffset(-75, -196)
    else
        PasteWithOffset(-103, -218)
    endif
    RemoveOverlap()
    Simplify()
    RoundToInt()
...
# j (セリフを付けて右に移動、narrow にする)
 ...
 #    SelectMore(0u03f3) # ϳ
    ...
    SelectMore(0u0458) # ј
    if (input_list[i] == "${input_latin_regular}")
        PasteWithOffset(-73, -196)
    else
        PasteWithOffset(-107, -218)
    endif
    RemoveOverlap()
    Simplify()
    RoundToInt()
...
# ¥ (新規作成)
    ...
    Copy()
    Select(0u00a5) # ¥
    PasteWithOffset(0, -390)
    if (input_list[i] == "${input_latin_regular}")
        PasteWithOffset(0, -550)
    else
...
# ドット無し0を保管
    # 通常 (上付き、下付きは後で加工)
    Select(65582); Copy() # ドット無し0
    Select(${address_store_zero}); Paste(); SetWidth(${width_latin}) # 保管所
    ...
    Select(65582); Clear() # ドット無し0

# スラッシュ0を保管
    # 通常 (上付き、下付きは後で加工)
    Select(65581); Copy() # スラッシュ0
    Select(${address_store_zero} + 6); Paste(); SetWidth(${width_latin}) # 保管所
...
# ⁄ (Slash と区別するため分割、角度変更)
    ...
    Scale(120); Copy()
    Select(0u2044) # ⁄
    PasteWithOffset(337, 359); PasteWithOffset(-337, -359)
    OverlapIntersect()
    SetWidth(${width_latin})
...
# ¦ (隙間を開ける)
    ...
    Select(0u00a6); Paste() # ¦
    Move(0, 575)
    PasteWithOffset(0, -575)

    # |
    Select(0u007c) # |
    Move(0, 485)
    PasteWithOffset(0, -485)
...
# \ (ss13 用のグリフを作る)
    ...
    Scale(120); Copy()
    if (input_list[i] == "${input_latin_regular}")
        Move(-25, 0); PasteWithOffset(25, 0)
    else
        Move(-57, 0); PasteWithOffset(57, 0)
    endif
...
# Change the scale of hankaku glyphs
 ...
 #        SelectMore(0u1d538, 0u1d56b) # 数学用英数字記号
        ...
        foreach
            if (WorthOutputting())
                if (GlyphInfo("Width") <= 350)
                    Scale(${scale_width_latin}, ${scale_height_latin}, ${width_latin_thin} / 2, 0)
                    Move(${width_latin_thin} / 4, 0)
                    Move(${move_x_hankaku_latin} * 0.75, 0)
                    SetWidth(${width_hankaku_narrow}) # thin は全て narrow に変換
                elseif (GlyphInfo("Width") <= 480)
                    Scale(${scale_width_latin}, ${scale_height_latin}, ${width_latin_narrow} / 2, 0)
                    Move(${move_x_hankaku_latin} * 0.75, 0)
                    SetWidth(${width_hankaku_narrow})
                elseif (GlyphInfo("Width") <= 700)
                    Scale(${scale_width_latin}, ${scale_height_latin}, ${width_latin} / 2, 0)
                    Move(${move_x_hankaku_latin}, 0)
                    SetWidth(${width_hankaku})
                elseif (GlyphInfo("Width") <= 950)
                    Scale(${scale_width_latin}, ${scale_height_latin}, ${width_latin_wide} / 2, 0)
                    Move(${move_x_hankaku_latin} * 1.5, 0)
...
# 一部を除いた半角文字を拡大
 ...
 #        SelectMore(0u1d538, 0u1d56b) # 数学用英数字記号
        ...
        foreach
            if (WorthOutputting())
                if (GlyphInfo("Width") <= 480)
                    Scale(${scale_width_hankaku}, ${scale_height_hankaku}, ${width_hankaku_narrow} / 2, 0)
                    SetWidth(${width_hankaku_narrow})
                elseif (GlyphInfo("Width") <= 700)
...
# 記号を一部クリア
    ...
    Select(0u2028, 0u2029); Clear() # line separator, paragraph separator
...
# Set configuration
 ...
 #    endif
    ...
    SetOS2Value("HHeadDescent",         -${hhea_descent1024})
    SetOS2Value("HHeadLineGap",          ${hhea_linegap1024})
    SetPanose([2, 11, panoseweight_list[i], 0, 2, 2, 3, 2, 2, 7])
...
# スペースの width 変更 (その他のスペースにグリフをペースト)
    ...
    # 可視化した半角スペースを3/4幅に合わせる
    Select(0u0020) # space
    SelectMore(0u00a0) # no-break space
    Move(-64 - ${move_x_hankaku} / 4, 0)
    SetWidth(${width_hankaku_narrow}) # スペース 3/4幅
    ...
    Paste(); SetWidth(${width_hankaku}) # スペース 半角幅

    Select(0u2007) # figure space
    SelectMore(0u202f) # narrow no-break space
    VFlip(); CorrectDirection()
    SetWidth(${width_hankaku}) # スペース 半角幅
...
# 半角英数記号を全角形にコピー、加工
    ...
    while (j < 93)
        if (j != 62\
         ...
         && j != 11 && j != 13) # ＿ （［｛ ）］｝ ，．
          ...
          if (GlyphInfo("Width") <= 480)
              Move(320 - ${move_x_hankaku_narrow}, 0)
          elseif (GlyphInfo("Width") <= 700)
              Move(256 - ${move_x_hankaku}, 0)
          elseif (GlyphInfo("Width") <= 900)
              Move(128 - ${move_x_hankaku_wide}, 0)
          endif
        endif
 #        if (j == 7 || j == 58 || j == 90) # （ ［ ｛
 ...
 #    SetWidth(${width_zenkaku})
    ...
    Select(0u203c); Paste() # ‼
    Move(70, 0)
    Select(0u203c); PasteWithOffset(445, 0) # ‼
    ...
    Move(88, 0)
    Select(0u0021); Copy() # !
    Select(0u2048); PasteWithOffset(445, 0) # ⁈
    Move(-${move_x_hankaku}, 0)
    SetWidth(${width_zenkaku})
...
# ss17 大文字と同じ形状の小文字に上線
    ...
    while (j < SizeOf(small))
        ...
        Select(k)
        if (small[j] == 0u0077) # w
            PasteWithOffset(128 + ${move_x_hankaku} / 2, 0)
        else
            PasteInto()
        endif
...
# SelectFewer(0u2000, 0u2140) # 文字様記号
    SelectFewer(0u200c, 0u200d) # zero width non-joiner, joiner
...
# 半角スペース消去
    if ("${visible_hankaku_space_flag}" == "false")
        ...
        Select(0u0020); Clear(); SetWidth(${width_hankaku_narrow}) # 半角スペース (スペース 3/4幅)
        Select(${address_calt_space}); Clear(); SetWidth(${width_hankaku_narrow}) # ss15用のダミー半角スペース (スペース 3/4幅)
    endif

# ノーブレークスペース消去
    if ("${visible_hankaku_space_flag}" == "false" && "${visible_other_space_flag}" == "false")
        Select(0u00a0); Clear(); SetWidth(${width_hankaku_narrow}) # ノーブレークスペース (スペース 3/4幅)
    endif
...
# その他のスペース消去
    if ("${visible_other_space_flag}" == "false")
        ...
        SelectMore(0u202f) # narrow no-break space
        SelectMore(0u205f) # medium mathematical space
        Clear(); SetWidth(${width_hankaku}) # スペース 半角幅
